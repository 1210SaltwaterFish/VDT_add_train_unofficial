    ...
    for epoch in range(args.epochs):
        ...
        with tqdm(total=len(loader), desc=f'Epoch {epoch}/{args.epochs}', unit='sample') as pbar:
            for idx, clip in enumerate(loader):
                ...
                print("mask.shape:",mask.shape)#1,12,8,8
                print("clip.shape:",clip.shape)#1，12，4，8，8
                print("clip.shape[0]",clip.shape[0])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--global-seed", type=int, default=-1)#0
