...
parser.add_argument("--ckpt", type=str, default="/home/ligongru/VDT_unofficial/results/000-VDT-L-2/checkpoints/0120000.pt",
...
def load_and_preprocess_video(path, batch_size=8, frames_per_batch=16, target_size=(args.image_size, args.image_size)):
...
print("x.shape:",x.shape) #8,5,4,8,8
...
# print(samples.shape)
save_image(samples.reshape(-1, samples.shape[-3], samples.shape[-2], samples.shape[-1]), "output_own20.png", nrow=args.num_frames, normalize=True, value_range=(-1, 1))